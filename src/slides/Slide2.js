...
const Slide2 = () => {
  const agendaData = [
    ...
    {
      number: '03',
      title: 'Building a CG + Live Action Visual Team',
      description: 'Scaling and building talent and infrastructure for professional productions.'
    },
    {
      number: '04',
  ...
  const leftContent = (
    <>
      <Eyebrow>Portfolio Presentation</Eyebrow>
